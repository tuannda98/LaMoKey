...
#define APP_SET_DATA(KEY, VAL) KEY = VAL; LaMoKeyHelper::setRegInt(_T(#KEY), KEY)
#define APP_GET_DATA(KEY, DEFAULT_VAL) KEY = LaMoKeyHelper::getRegInt(_T(#KEY), DEFAULT_VAL)

#define APP_CLASS _T("LaMoKeyVietnameseInputMethod")
