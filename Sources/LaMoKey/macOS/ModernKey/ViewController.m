...
- (void)viewDidLoad {
    ...
    NSArray* codeData = [LaMoKeyManager getTableCodes];
...
- (void)viewDidAppear {
    [super viewDidAppear];
    NSString* str = @"LaMoKey %@ - Bộ gõ Tiếng Việt";
...
- (IBAction)onTempOffLaMoKeyByHotKey:(id)sender {
    NSInteger val = [self setCustomValue:sender keyToSet:@"vTempOffLaMoKey"];
    vTempOffLaMoKey = (int)val;
}
...
-(void)fillData {
    ...
    value = [[NSUserDefaults standardUserDefaults] integerForKey:@"vTempOffLaMoKey"];
    self.TempOffLaMoKey.state = value ? NSControlStateValueOn : NSControlStateValueOff;
